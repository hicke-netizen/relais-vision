...
import { Menu, X, Calendar, HelpCircle, Accessibility } from "lucide-react";
    ...
    <header className="fixed top-0 left-0 right-0 z-50">
      ...
      <div className="bg-ocean-900 text-white py-3 px-4">
        <div className="max-w-7xl mx-auto flex items-center justify-center text-sm">
          ...
          <a href={`tel:${siteConfig.telephone}`} className="font-bold ml-1 text-white hover:underline">
      ...
      <div className="bg-white/90 backdrop-blur-xl border-b border-cloud-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-[72px]">
            ...
            {/* ✅ MODIFIÉ : Logo avec ville depuis siteConfig */}
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-ocean-600 text-sm font-medium">{siteConfig.ville}</span>
              </div>
            </Link>
            ...
            {/* ✅ MODIFIÉ : Bouton Doctolib depuis siteConfig */}
      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-white border-b border-cloud-100 shadow-lg">
          <div className="max-w-7xl mx-auto px-4 py-4">
            ...
            {/* ✅ MODIFIÉ : Bouton mobile Doctolib depuis siteConfig */}
